...
const user_controller_1 = require("./infrastructure/interface/user.controller");
const handlers_1 = require("./application/command/handlers");
const handlers_2 = require("./application/query/handlers");
...
exports.UserModule = UserModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [...handlers_1.commandsHandlers, ...handlers_2.queryHandlers],
